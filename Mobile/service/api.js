...
const urlApi = "http://192.168.0.55:7070/";
...
export const addPost = (data, token) => post(urlApi + "post", data, {headers: {Authorization: token}});
export const postRegister = (data) => post(urlApi + "register", data);
export const getLatestPost = () => get(urlApi + "latestPosts");
export const getLoggedUser = (token) => get(urlApi + "user", {headers: {Authorization: token}});
export const getUser = (id) => get(urlApi + "user/" + id);
export const addRemoveFollow = (id, token) => put(urlApi + 'user/' + id + '/follow', undefined, {headers: {Authorization: token}});
...
export const addComment = (id, data, token) => post(urlApi + 'post/' + id + '/comment', data, {headers: {Authorization: token}});
export const addRemoveLike = (id, token) => put(urlApi + 'post/' + id + '/like', undefined, {headers: {Authorization: token}});
